...
class BulldozerHelpFormatter(argparse.RawTextHelpFormatter):
    ...
    def bulldozer_add_usage(
        self,
        positionals: Optional[list[argparse.Action]] = None,
        optionals: Optional[list[argparse.Action]] = None,
        commons: Optional[list[argparse.Action]] = None,
        ...
        if add_epilog:
            if self.epilog:
                if long_help:
                    ...
                    formatter.add_text(f"For more details, consult the documentation.")
                else:
